        ...
        <div class="row justify-content-center mt-5">
            <div class="col-md-6">
                <div class="card p-4">
                    ...
                    <h1 class="text-center mt-3">แก้ไขข้อมูลผู้ดูแลระบบ</h1>
                    <input type="hidden" name="id" value="<?php echo $row['m_id'] ?>">
                    <label for="user" class="form-label">ชื่อผู้ดูแลระบบ</label>
                    ...
                    <div class="d-flex gap-3">
                        <input type="submit" name="submit" class="btn btn-primary w-100 mt-3 mb-1" value="แก้ไขข้อมูล">
                        <!-- <input type="reset" name="reset" class="btn btn-danger w-100 mb-1" value="ยกเลิก"> -->
                        <a class="btn btn-success w-100 mb-1 mt-3 text-white" href="admin.php"><i class="bi bi-backspace"></i> ย้อนกลับ</a>
                    </div>
                    </form>
                    <?php } ?>
                </div>
